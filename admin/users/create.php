...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM users WHERE judul_artikel='$judul_artikel'";
    ...
    $result = mysqli_query($mysqli, "INSERT INTO users(judul_artikel,created_time,user_id,id_kategori, content_artikel,cover)
